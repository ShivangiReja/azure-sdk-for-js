...
function sendMessages() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const nsSend = lib_1.Namespace.createFromConnectionString(connectionString);
        ...
        for (let index = 0; index < data.length; index++) {
            ...
            promises.push(lib_1.delay(Math.random() * 30).then(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
...
function receiveMessage() {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const nsRcv = lib_1.Namespace.createFromConnectionString(connectionString);
