...
class PartitionContext {
    ...
    getInitialOffset() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!startingCheckpoint) {
                ...
                partitionContext(withHostAndPartiton(this, "Retrieved starting offset/sequence " +
                    "number: %s/%d"), this._offset, this._sequenceNumber);
            }
            partitionContext(withHostAndPartiton(this, "Initial position provider offset: %s, " +
     ...
     * @ignore
     */
    _persistCheckpoint(checkpoint$$1) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const withHostAndPartiton = this._context.withHostAndPartition;
            try {
                const inStoreCheckpoint = yield this._context.checkpointManager.getCheckpoint(checkpoint$$1.partitionId);
                if (inStoreCheckpoint && inStoreCheckpoint.sequenceNumber >= checkpoint$$1.sequenceNumber) {
                    const msg = `Ignoring out of date checkpoint with offset: '${checkpoint$$1.offset}', ` +
                        `sequenceNumber: ${checkpoint$$1.sequenceNumber} because currently persisted checkpoint ` +
                ...
                partitionContext(withHostAndPartiton(this, "Persisting the checkpoint: %O."), checkpoint$$1);
                yield this._context.checkpointManager.updateCheckpoint(this.lease, checkpoint$$1);
                partitionContext(withHostAndPartiton(this, "Successfully persisted the checkpoint: %O."), checkpoint$$1);
            }
            catch (err) {
                const msg = `An error occurred while checkpointing info for partition ` +
                    `'${checkpoint$$1.partitionId}': ${err ? err.stack : JSON.stringify(err)}.`;
                error(withHostAndPartiton(this, "%s"), msg);
                throw err;
            }
        });
...
class PartitionPump {
    ...
    _createNewReceiver() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                error(withHostAndPartition(partitionId, "An error occurred while creating " +
            ...
            const onError = (error$$1) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            partitionPump(withHostAndPartition(partitionId, "Trying to create receiver in " +
                "consumergroup: '%s' with epoch %d from offset: %s."), rcvrOptions.consumerGroup, rcvrOptions.epoch, eventPosition.getExpression());
    ...
    _leaseRenewer() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            let result = true;
            let error$$1;
            partitionPump(withHostAndPartition(this._lease, "Lease renewer is active after " +
            ...
            if (!result) {
                error(withHostAndPartition(this._lease, "Failed to renew the lease, result: %s. " +
    ...
    _scheduleLeaseRenewer() {
        ...
        this._leaseRenewalTimer = setTimeout(() => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
    ...
    _removeReceiver(reason) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const partitionContext$$1 = this._partitionContext;
            const partitionId = partitionContext$$1.partitionId;
            ...
            if (receiveHandler && this._client) {
                ...
                if (reason !== CloseReason.leaseLost) {
                    try {
                        partitionPump(withHostAndPartition(partitionContext$$1, "Releasing lease %s after closing the receiver '%s' due to reason '%s'."), leaseId, receiveHandler.address, reason);
                        yield this._context.leaseManager.releaseLease(partitionContext$$1.lease);
                    }
                    catch (err) {
            ...
            try {
                ...
                if (capturedPump) {
                    ...
                    if (!isOpen) {
                        ...
                        pumpManager(withHostAndPartition(partitionId, "Updating lease for pump since it" +
...
class PartitionScanner {
    ...
    scan(isFirst) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                partitionScanner(withHost("Attempting to acquire %d leases in parallel starting from " +
    ...
    _acquireExpiredInParallel(startAt, needed) {
        ...
        if (needed > 0 && this._unownedCount > 0 && startAt < this._allLeaseStates.length) {
            ...
            const leaseManager$$1 = this._context.leaseManager;
            const getTheseResult = [];
            for (const thisLease of getThese) {
                let lease = undefined;
                const getThisPromise = leaseManager$$1.getLease(thisLease.partitionId).then((receivedLease) => {
                    lease = receivedLease;
                    if (lease) {
                        return leaseManager$$1.acquireLease(lease);
                    }
                    else {
                        return false;
                    }
            ...
            return resultPromise.then(() => {
                return Promise.all(getTheseResult).catch((err) => {
                    ...
                    partitionScanner(withHost("Calling _acquireExpiredInParallel with startAt %d, " +
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (stealThese.length > 0) {
                ...
                for (const stealableLease of stealThese) {
                    let lease = undefined;
                    const tryStealPromise = this._context.leaseManager.getLease(stealableLease.partitionId).then((receivedLease) => {
                        lease = receivedLease;
                        if (receivedLease) {
...
class PartitionManager {
    ...
    shouldStop() {
        if (this._isCancelRequested) {
            partitionManager(this._context.withHost("Cancellation was requested -> %s. " +
    ...
    _initializeStores() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (!(yield leaseManager$$1.leaseStoreExists())) {
                const config = {
                    hostName: hostName,
                    operation: () => leaseManager$$1.createLeaseStoreIfNotExists(),
            ...
            const leaseConfig = {
                hostName: hostName,
                operation: () => leaseManager$$1.createAllLeasesIfNotExists(this._context.partitionIds),
    ...
    _scan(isFirst) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            while (!this.shouldStop()) {
                ...
                let seconds = didSteal ? this._context.fastScanInterval : this._context.slowScanInterval;
                if (isFirst) {
...
const userAgentPrefix = "/js-event-processor-host";
    ...
    doesContainerExist(containerName) {
        ...
        return new Promise((resolve, reject) => {
            this._storageBlobService.doesContainerExist(containerName, (error$$1, result) => {
                if (error$$1) {
                    error("[%s] An error occurred while determining whether the container " +
                        "'%s' exists: % O.", this._hostName, containerName, getStorageError(error$$1));
                    reject(error$$1);
                }
                else {
...
class AzureStorageCheckpointLeaseManager {
    ...
    downloadLease(partitionId, blob) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const blobLeaseInfo = Object.assign({}, jsonLease, { blob: blob });
    ...
    deleteLeaseStore() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const blobService$$1 = this._context.blobService;
            const storageContainerName = this._context.storageContainerName;
            try {
                if (blobService$$1) {
                    const listResult = yield blobService$$1.listBlobsSegmented(storageContainerName);
                    const deleteBlobs = [];
                    for (const blob of listResult.entries) {
                        deleteBlobs.push(blobService$$1.deleteBlobIfExists(storageContainerName, blob.name));
                    }
                    yield Promise.all(deleteBlobs);
                    yield blobService$$1.deleteContainerIfExists(storageContainerName);
                }
                else {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const lbi of leaseBlobs) {
                    ...
                    result.push(lease);
                    checkpointLeaseMgr(withHostAndPartition(partitionId, "BlobResult item from the list " +
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (leaseBlobs.length === partitionIds.length) {
                    checkpointLeaseMgr(withHost("Number of blobs %d === Number of partitionIds %d. " +
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if ((statusCode === 412 && code && code.toLowerCase() === "leaseidmissing") ||
                    ...
                    error(withHostAndPartition(partitionId, "An error occurred while creating lease if " +
                        "it does not exist: %O."), error$$1);
                    throw error$$1;
                }
            }
            return returnLease;
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (blobResult.lease && blobResult.lease.state && blobResult.lease.state === "leased") {
                    ...
                    checkpointLeaseMgr(withHostAndPartition(lease, "Need to change lease '%s' -> '%s' " +
    ...
    releaseLease(lease) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const releasedCopy = new AzureBlobLease(Object.assign({}, lease.getInfo(), { blob: lease.blob }));
                releasedCopy.owner = "";
                releasedCopy.token = "";
    ...
    updateCheckpoint(lease, checkpoint$$1) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const withHostAndPartition = this._context.withHostAndPartition;
            checkpointLeaseMgr(withHostAndPartition(checkpoint$$1, "Checkpoint at offset '%s' and seqno %d."), checkpoint$$1.offset, checkpoint$$1.sequenceNumber);
            lease.offset = checkpoint$$1.offset;
            lease.sequenceNumber = checkpoint$$1.sequenceNumber;
            try {
                if (yield this.updateLease(lease)) {
                    ...
                    const msg = `Lease lost while updating the checkpoint for partitionId ` +
                        `'${checkpoint$$1.partitionId}'.Hence could not update it.`;
                ...
                const info = {
                    ...
                    error: err,
                    hostName: this._context.hostName,
                    partitionId: checkpoint$$1.partitionId
                };
                this._context.onEphError(info);
            }
        });
    ...
    _listBlobs() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const withHost = this._context.withHost;
            if (blobService$$1) {
                const listResult = yield blobService$$1.listBlobsSegmented(this._context.storageContainerName);
    ...
    _uploadLease(lease, activity, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            if (activity !== UploadActivity.create) {
                ...
                if (this._latestCheckpoint.has(partitionId)) {
                    ...
                    if (cached.sequenceNumber > lease.sequenceNumber || lease.offset == undefined) {
                        ...
                        checkpointLeaseMgr(withHostAndPartition(lease, "Updating stale offset/seqno with " +
            ...
            checkpointLeaseMgr(withHostAndPartition(lease, "Trying to upload raw JSON for activity " +
...
(function (HostContext) {
    ...
    function _eitherLeaseManagerOrleaseDurationAndRenewal(options) {
        validateType("options", options, true, "object");
        const leaseManager = options.leaseManager;
    ...
    function _createWithCheckpointLeaseManager(hostName, options) {
        ...
        ctxt.getEventHubClient = () => {
            if (ctxt.tokenProvider) {
                return eventHubs.EventHubClient.createFromTokenProvider(ctxt.connectionConfig.host, ctxt.eventHubPath, ctxt.tokenProvider, { userAgent: ctxt.userAgent });
            }
            else {
                return eventHubs.EventHubClient.createFromConnectionString(ctxt.eventHubConnectionString, ctxt.eventHubPath, { userAgent: ctxt.userAgent });
            }
        };
        ctxt.getHubRuntimeInformation = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        ctxt.getPartitionInformation = (id) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const client = ctxt.getEventHubClient();
            try {
        ...
        ctxt.getPartitionIds = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
...
class EventProcessorHost {
    ...
    static createFromConnectionString(hostName, storageConnectionString, storageContainerName, eventHubConnectionString, options) {
        ...
        validateType("options", options, false, "object");
        const ephOptions = Object.assign({}, options, { storageConnectionString: storageConnectionString, storageContainerName: storageContainerName, eventHubConnectionString: eventHubConnectionString });
     ...
     * @returns {EventProcessorHost} EventProcessorHost
     */
    static createFromConnectionStringWithCustomCheckpointAndLeaseManager(hostName, eventHubConnectionString, checkpointManager, leaseManager$$1, options) {
        if (!options)
            options = {};
        validateType("hostName", hostName, true, "string");
        validateType("eventHubConnectionString", eventHubConnectionString, true, "string");
        validateType("checkpointManager", checkpointManager, true, "object");
        validateType("leaseManager", leaseManager$$1, true, "object");
        validateType("options", options, false, "object");
        const ephOptions = Object.assign({}, options, { eventHubConnectionString: eventHubConnectionString, checkpointManager: checkpointManager, leaseManager: leaseManager$$1 });
        return new EventProcessorHost(hostName, ephOptions);
    }
    /**
    ...
    static createFromTokenProvider(hostName, storageConnectionString, storageContainerName, namespace, eventHubPath, tokenProvider, options) {
        ...
        const ephOptions = Object.assign({}, options, { tokenProvider: tokenProvider, storageConnectionString: storageConnectionString, storageContainerName: storageContainerName, eventHubPath: eventHubPath, eventHubConnectionString: connectionString });
        return new EventProcessorHost(hostName, ephOptions);
    }
    /**
     ...
     * @returns {EventProcessorHost} EventProcessorHost
     */
    static createFromTokenProviderWithCustomCheckpointAndLeaseManager(hostName, namespace, eventHubPath, tokenProvider, checkpointManager, leaseManager$$1, options) {
        if (!options)
            options = {};
        validateType("hostName", hostName, true, "string");
        validateType("namespace", namespace, true, "string");
        ...
        const connectionString = `Endpoint=sb://${namespace};SharedAccessKeyName=defaultKeyName;` +
            `SharedAccessKey=defaultKeyValue;EntityPath=${eventHubPath}`;
        const ephOptions = Object.assign({}, options, { tokenProvider: tokenProvider, eventHubPath: eventHubPath, eventHubConnectionString: connectionString, checkpointManager: checkpointManager, leaseManager: leaseManager$$1 });
        return new EventProcessorHost(hostName, ephOptions);
    }
    /**
    ...
    static createFromAadTokenCredentials(hostName, storageConnectionString, storageContainerName, namespace, eventHubPath, credentials, options) {
        ...
        const connectionString = `Endpoint=sb://${namespace};SharedAccessKeyName=defaultKeyName;` +
            `SharedAccessKey=defaultKeyValue;EntityPath=${eventHubPath}`;
        const ephOptions = Object.assign({}, options, { tokenProvider: new eventHubs.AadTokenProvider(credentials), storageConnectionString: storageConnectionString, storageContainerName: storageContainerName, eventHubPath: eventHubPath, eventHubConnectionString: connectionString });
        return new EventProcessorHost(hostName, ephOptions);
    }
    /**
     ...
     * @returns {EventProcessorHost} EventProcessorHost
     */
    static createFromAadTokenCredentialsWithCustomCheckpointAndLeaseManager(hostName, namespace, eventHubPath, credentials, checkpointManager, leaseManager$$1, options) {
        if (!options)
            options = {};
        validateType("hostName", hostName, true, "string");
        validateType("namespace", namespace, true, "string");
        ...
        const connectionString = `Endpoint=sb://${namespace};SharedAccessKeyName=defaultKeyName;` +
            `SharedAccessKey=defaultKeyValue;EntityPath=${eventHubPath}`;
        const ephOptions = Object.assign({}, options, { tokenProvider: new eventHubs.AadTokenProvider(credentials), eventHubPath: eventHubPath, eventHubConnectionString: connectionString, checkpointManager: checkpointManager, leaseManager: leaseManager$$1 });
        return new EventProcessorHost(hostName, ephOptions);
    }
    /**
    ...
    static createFromIotHubConnectionString(hostName, storageConnectionString, storageContainerName, iotHubConnectionString, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const ephOptions = Object.assign({}, options, { storageConnectionString: storageConnectionString, storageContainerName: storageContainerName, eventHubConnectionString: eventHubConnectionString, eventHubPath: client.eventhubName });
            return new EventProcessorHost(hostName, ephOptions);
        });
    }
    /**
     ...
     * @returns {EventProcessorHost} EventProcessorHost
     */
    static createFromIotHubConnectionStringWithCustomCheckpointAndLeaseManager(hostName, iotHubConnectionString, checkpointManager, leaseManager$$1, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!options)
                options = {};
            validateType("hostName", hostName, true, "string");
            ...
            /* tslint:disable:no-string-literal */
            const eventHubConnectionString = client["_context"].config.connectionString;
            const ephOptions = Object.assign({}, options, { eventHubConnectionString: eventHubConnectionString, checkpointManager: checkpointManager, leaseManager: leaseManager$$1, eventHubPath: client.eventhubName });
            return new EventProcessorHost(hostName, ephOptions);
        });
    }
}
...
describe("EPH", function () {
    before("validate environment", function () {
        should$1.exist(process.env.STORAGE_CONNECTION_STRING, "define STORAGE_CONNECTION_STRING in your environment before running integration tests.");
    ...
    describe("user-agent", function () {
        it("should be populated correctly as a part of the connection property", function (done) {
            ...
            should$1.equal(properties["user-agent"], `/js-event-hubs,${ua}`);
        ...
        it("should support appending custom user-agent", function (done) {
            ...
            const ehc = context.getEventHubClient();
            const properties = ehc["_context"].connection.options.properties;
            should$1.equal(properties["user-agent"], `/js-event-hubs,${ua},${customua}`);
            should$1.equal(properties.product, "MSJSClient");
            done();
        });
    });
        ...
        it("should checkpoint messages in order", function (done) {
            const test = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                host = EventProcessorHost.createFromConnectionString(EventProcessorHost.createHostName(), storageConnString, EventProcessorHost.createHostName("single"), ehConnString, {
                    eventHubPath: hubName,
                    initialOffset: eventHubs.EventPosition.fromEnqueuedTime(Date.now())
                });
                ...
                const ehc = eventHubs.EventHubClient.createFromConnectionString(ehConnString, hubName);
    ...
    describe("multiple", function () {
        it("should be able to run multiple eph successfully.", function (done) {
            const test = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                const ehc = eventHubs.EventHubClient.createFromConnectionString(ehConnString, hubName);
                const containerName = `sharedhost-${v4_1()}`;
                const now = Date.now();
                const hostByName = {};
                ...
                for (let i = 0; i < ids.length; i++) {
                    ...
                    hostByName[hostName] = EventProcessorHost.createFromConnectionString(hostName, storageConnString, containerName, ehConnString, {
                        eventHubPath: hubName,
                        initialOffset: eventHubs.EventPosition.fromEnqueuedTime(now),
                    });
                    const onError = (error) => {
    ...
    describe("runtimeInfo", function () {
        it("should get hub runtime info correctly", function (done) {
            const test = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                should$1.equal(Array.isArray(hubRuntimeInfo.partitionIds), true);
                should$1.equal(typeof hubRuntimeInfo.partitionCount, "number");
                yield host.stop();
            });
            test().then(() => { done(); }).catch((err) => { done(err); });
        });
        it("should get partition runtime info correctly with partitionId as string", function (done) {
            const test = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                should$1.exist(partitionInfo.lastSequenceNumber);
                should$1.exist(partitionInfo.lastEnqueuedOffset);
                yield host.stop();
            });
            test().then(() => { done(); }).catch((err) => { done(err); });
        });
...
chai$1.use(chaiAsPromised);
const debug$1 = debugModule("azure:eph:iothub-spec");
main.config();
describe("EPH with iothub connection string", function () {
    ...
    before("validate environment", function () {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            should$2.exist(process.env.IOTHUB_CONNECTION_STRING, "define IOTHUB_CONNECTION_STRING in your environment before running integration tests.");
        });
    });
    it("should be able to receive messages from the event hub associated with an iothub.", function (done) {
        const test = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const onMessage = (context, data) => {
                    debug$1(">>> [%s] Rx message from '%s': '%O'", hostName, context.partitionId, data);
                };
                const onError = (err) => {
                    debug$1("An error occurred while receiving the message: %O", err);
                    throw err;
                };
                const runtimeInfo = yield host.getHubRuntimeInformation();
                debug$1(">>>> runtimeInfo: %O", runtimeInfo);
...
const debug$2 = debugModule("azure:eph:negative-spec");
main.config();
describe("negative", function () {
    before("validate environment", function () {
        should$3.exist(process.env.STORAGE_CONNECTION_STRING, "define STORAGE_CONNECTION_STRING in your environment before running integration tests.");
        should$3.exist(process.env.EVENTHUB_CONNECTION_STRING, "define EVENTHUB_CONNECTION_STRING in your environment before running integration tests.");
        should$3.exist(process.env.EVENTHUB_NAME, "define EVENTHUB_NAME in your environment before running integration tests.");
    });
    const ehConnString = process.env.EVENTHUB_CONNECTION_STRING;
    const storageConnString = process.env.STORAGE_CONNECTION_STRING;
    const hubName = process.env.EVENTHUB_NAME;
    ...
    it("should fail when trying to start an EPH that is already started.", function (done) {
        const test = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const onMessage = (context, data) => {
                debug$2(">>> [%s] Rx message from '%s': '%O'", hostName, context.partitionId, data);
            };
            const onError = (err) => {
                debug$2("An error occurred while receiving the message: %O", err);
                throw err;
            };
            yield host.start(onMessage, onError);
            try {
                debug$2(">>> [%s] Trying to start second time.", hostName);
                yield host.start(onMessage, onError);
                ...
                yield host.stop();
                should$3.equal(host["_context"]["partitionManager"]["_isCancelRequested"], true);
            }
        });
        test().then(() => { done(); }).catch((err) => { done(err); });
    });
...
const debug$3 = debugModule("azure:eph:retry-spec");
describe("retry function", function () {
    it("should succeed if the operation succeeds.", function (done) {
        const test = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const config = {
                    operation: () => tslib_1.__awaiter(this, void 0, void 0, function* () {
                        debug$3("counter: %d", ++counter);
                        yield eventHubs.delay(200);
                        return {
                            code: 200,
                            description: "OK"
                        };
                ...
                const result = yield retry(config);
                result.code.should.equal(200);
                result.description.should.equal("OK");
                counter.should.equal(1);
            }
            catch (err) {
                debug$3("An error occurred in a test that should have succeeded: %O", err);
                throw err;
            }
        });
        test().then(() => { done(); }).catch((err) => { done(err); });
    ...
    it("should succeed if the operation initially fails and then succeeds.", function (done) {
        const test = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const result = yield retry(config);
                should$4.equal(Array.isArray(result), true);
